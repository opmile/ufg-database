...
<img src="fig-esquema-logico-bdempresa.jpg" width="450">
...
|Álgebra Relacional|SQL|
|-|-|
|π <sub>Cpf, Pnome, Unome</sub> (<br>σ <sub>Sexo='F'</sub> (FUNCIONARIO))<br><br>FUNC_F ← σ <sub>Sexo='F'</sub> (FUNCIONARIO)<br>π <sub>Cpf, Pnome, Unome</sub> (FUNC_F)|SELECT Cpf, Pnome, Unome <br>FROM FUNCIONARIO <br> WHERE Sexo='F' <br><br>SELECT Cpf, Pnome, Unome <br>FROM (SELECT * FROM FUNCIONARIO WHERE Sexo='F') AS FUNC_F|
